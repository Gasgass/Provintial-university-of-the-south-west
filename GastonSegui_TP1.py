"""Intente abarcar la mayor cantidad de valores posibles pero no logre solucionar el ingreso de numeros Reales,
como asi tambien que si el programa ingresa datos de tipo str vuelva al inicio y se pida sin prints ni inputs que se ingrese un valor correcto"""
